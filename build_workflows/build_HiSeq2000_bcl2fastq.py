...
def main():
	dry_run = True	# Test mode - doesn't work
	...
	workflow_project_dxid = 'project-Bp5PgYj0fGkjfXy1q1x998Fy'
	workflow_object_dxid = ''
	bcl2fastq_stage_dxid = ''
	workflow_name = 'WF_HiSeq2000_bcl2fastq'
	...
	if not workflow_project_dxid:
		workflow_project_dxid = dxpy.api.project_new(input_params={
			'name' : workflow_name,
			'summary' : 'Convert HiSeq 2000 bcl files to fastq',
