...
class WorkflowConfig:
    ...
    def __init__(self, config_path, workflow_config_dir):
        ...
        self.new_workflow = True 
        ''' Dev: right now I have to rebuild workflows each time because I always create
                 new applets. Then I fail to load old workflows because their applets don't
                 exist (unless from old build dir). Need to update this to only rebuild
                 applets if source has changed.

                 Even then... how to keep track of workflows
        '''
...
def main():
    ...
    workflow_config_basename = 'wf_bcl2fastq_qc.json'
