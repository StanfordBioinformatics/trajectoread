...
class Workflow:
	...
	def create_new_workflow_project(self):
		...
		self.project_dxid = dxpy.api.project_new(input_params={
			'name' : self.name,
...
def main():
	...
	workflow_project_dxid = 'project-BpP8Yg00zz07ffjx0Ggjk71f'
	workflow_object_dxid = ''
	workflow_name = 'WF_bwa_mem-qc_sample'
	...
	internal_rscs['qc_sample'] = {'c_program': ['bwa_mismatches', 'collect_uniqueness_metrics']}
